...
if __name__ == "__main__":
    ...
    # 로컬 이미지 경로
    image_path = "D:/Streamlit_UI/frontend/static/images/test_image2.jpg"
    ...
    .click-box.expanded img {{
        height: 800px;
    }}
    </style>

    <div class="click-box" onclick="this.classList.toggle('expanded')">
        <img src="data:image/jpeg;base64,{encoded_image}" alt="이미지" />
    </div>
    """
